...
export default class {
  ...
  public async register(): Promise<void> {
    ...
    this.client.once("ready", async () => {
      ...
      spinner.succeed(
        `Ready (This version tries to improve audio quality)! Invite the bot with https://discordapp.com/oauth2/authorize?client_id=${this.client.user?.id ?? ""}&scope=bot%20applications.commands&permissions=36700160`,
      );
    });
